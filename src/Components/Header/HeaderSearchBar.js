...
const SearchBar = function () {
    ...
    return (
        <>
            <div
                className={`bg-black bg-opacity-90 w-[389px] h-[40px] flex flex-row rounded-lg ${focus ? "border-[#EE5566] border-2" : ""
                    }`}
            >
                <div className="flex justify-center items-center">
                    <AiOutlineSearch
                        className={`mx-2 text-xl ${focus ? "text-[#EE5566]" : "text-[#939393]"
                            }`}
                    />
                </div>
                <input
